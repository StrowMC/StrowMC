package fr.strow.core.module.moderation.command;
...
public class ModCommand extends EvolvedCommand {
    ...
    @Inject
    public ModCommand(MessageService messageService) {
        super(
                CommandDescription
                        .builder()
                        .withName("mod")
    ...
    protected void execute(CommandSender sender) {
        ...
        if (ModerationModule.isInModMode(player.getUniqueId())) {
            ...
            messageService.sendMessage(player.getUniqueId(), "%s §cTu n'est plus en mode staff.", ModerationModule.PREFIX);
        ...
        player.teleport(player.getWorld().getSpawnLocation());
        messageService.sendMessage(player.getUniqueId(), "%s §cTu est désormais en mode staff.", ModerationModule.PREFIX);
