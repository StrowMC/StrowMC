...
public class FactionDemoteCommand extends EvolvedCommand {
    ...
    @Inject
    public FactionDemoteCommand(CommandService commandService, PlayerManager playerManager, FactionManager factionManager, PermissionsManager permissionsManager, Messaging messaging) {
        super(CommandDescription.builder()
                .withName("demote")
                .withPermission("faction.demote")
                .withDescription("Rétrograder un membre de votre faction")
                .build());
    ...
    protected void execute(CommandSender sender) {
        ...
        FactionRole newRole = FactionRole.getRoleUnder(currentRole).get();
        ...
        messaging.sendMessage(faction, uuid -> !uuid.equals(player.getUniqueId()),"%s a été rétrogradé au rang de %s par %s !",
    ...
    static class DemotedMemberParameter extends Parameter<StrowPlayer> {
        ...
        @Inject
        public DemotedMemberParameter(MotedMemberParameter motedMemberParameter, PlayerManager playerManager, Messaging messaging) {
            super("joueur");
            ...
            conditions.add(
                    new Condition<String>() {
                        ...
                        public boolean check(String arg) {
                            ...
                            return playerRole != FactionRole.getLowestRole();
                        }
