...
public class CoinsAddCommand extends EvolvedCommand {

    private final CommandService commandService;
    private final Messaging messaging;

    @Inject
    public CoinsAddCommand(CommandService commandService, Messaging messaging) {
        super(CommandDescription.builder()
                .withName("add")
                .withDescription("Ajouter de l'argent au solde d'un joueur")
                .build());
